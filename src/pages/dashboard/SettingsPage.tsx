      ...
      <div className="flex flex-col lg:flex-row lg:items-start gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            ...
            <p className="text-xs text-muted-foreground mb-5">El tema que elijas aquí se aplicará a todos los usuarios por defecto. Cada usuario puede cambiarlo localmente sin afectar a los demás.</p>
            <div className="grid grid-cols-3 gap-3">
              {[
                ...
                <button key={id} onClick={() => {
                  ...
                  // Persist as the global default for all users
